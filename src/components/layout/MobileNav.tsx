...
import { BarChart, Book, Clock, Gauge, LineChart, Menu, PieChart, Scale, Trophy, X } from 'lucide-react';
...
const MobileNav: React.FC<MobileNavProps> = ({ activeSection, setActiveSection }) => {
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'prop-firm-comparison', label: '🏆 Prop Firm Comparison', icon: <Trophy className="h-5 w-5" />, path: '/prop-firm-comparison' },
  ];
