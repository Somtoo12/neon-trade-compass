...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto pb-1 scrollbar-none">
    <TabsPrimitive.List
      ref={ref}
      className={cn(
        "inline-flex min-w-full h-10 items-center justify-start rounded-md bg-muted p-1 text-muted-foreground",
        className
      )}
      {...props}
    />
