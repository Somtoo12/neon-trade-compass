...
const FocusMode = () => {
  ...
  return (
    <>
      <SEO 
        title="Focus Mode – Music & Tools to Stay Laser-Focused | PipCraft"
        description="Launch your trading focus mode with our Spotify-powered zone. Block distractions, stay in flow."
      />
